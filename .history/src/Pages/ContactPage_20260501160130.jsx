...
export default function ContactPage() {
  ...
  const place='Dreamily dental clinic'
  return (
   <>
...
<div className='w-full flex lg:me-6 flex-col space-y-5 items-center justify-center '>
  ...
  <div className="flex gap-2">
    <Link className='hover:underline'  to={`mailto:dreamilydentalclinic@gmail.com`}>
    <Button className='py-6 dark:text-white dark:bg-gray-600 bg-white' variant='faded'>  dreamilydentalclinic@gmail.com</Button>
    </Link>
