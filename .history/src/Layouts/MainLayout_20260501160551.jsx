...
const [darkMode, setDarkMode] = useState( localStorage.getItem('darkmode') === 'true'|| false)
 ...
 <div className='py-1 shadow sticky z-10 top-0 w-full dark:bg-black bg-white/90'>
...
<div className='flex items-center gap-8'>
  <div className="flex items-center gap-1">
    ...
    <div className='border border-transparent dark:bg-white size-16 flex justify-center items-center rounded-full'>
