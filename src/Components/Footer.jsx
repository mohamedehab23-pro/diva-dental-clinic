...
<div className="flex gap-3 items-center">
  <a className='hover:underline' href={`mailto:divadentalclinic@gmail.com`}><img src={mail} className='w-13' alt="" /></a>
  <a className='hover:underline' href={`https://wa.me/${number}`}><img src={whatsapp} className='w-10' alt="" /></a>
  <a href="https://www.facebook.com/share/1CNgfmMjNc/" target='_blank'><img src={face} className='w-10' alt="" /></a>
